...
const TermsConditions = () => {
  return (
    <div>
      ...
      <p>Welcome to Stagio!</p>

      <p>
        These terms and conditions outline the rules and regulations for the use
        of Stagio's Website, located at https://stagio.vercel.app/.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use Stagio if you do not agree to take
      ...
      <p>
        We employ the use of cookies. By accessing Stagio, you agreed to use
        cookies in agreement with the Stagio's Privacy Policy.{" "}
      </p>
      ...
      <p>
        Unless otherwise stated, Stagio and/or its licensors own the
        intellectual property rights for all material on Stagio. All
        intellectual property rights are reserved. You may access this from
        Stagio for your own personal use subjected to restrictions set in these
        terms and conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from Stagio</li>
        <li>Sell, rent or sub-license material from Stagio</li>
        <li>Reproduce, duplicate or copy material from Stagio</li>
        <li>Redistribute content from Stagio</li>
      </ul>
      ...
      <p>
        ...
        Stagio does not filter, edit, publish or review Comments prior to their
        presence on the website. Comments do not reflect the views and opinions
        of Stagio,its agents and/or affiliates. Comments reflect the views and
        opinions of the person who post their views and opinions. To the extent
        permitted by applicable laws, Stagio shall not be liable for the
      ...
      <p>
        Stagio reserves the right to monitor all Comments and to remove any
      ...
      <p>
        You hereby grant Stagio a non-exclusive license to use, reproduce, edit
      ...
      <p>
        ...
        the hyperlink compensates the absence of Stagio; and (d) the link is in
      ...
      <p>
        ...
        e-mail to Stagio. Please include your name, your organization name,
      ...
      <p>
        No use of Stagio's logo or other artwork will be allowed for linking
