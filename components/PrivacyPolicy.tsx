...
const PrivacyPolicy = () => {
  return (
    <div>
      <h1>Privacy Policy for Stagio</h1>

      <p>
        At Stagio, accessible from https://stagio.vercel.app/, one of our main
        priorities is the privacy of our visitors. This Privacy Policy document
        contains types of information that is collected and recorded by Stagio
        and how we use it.
      </p>
      ...
      <p>
        ...
        shared and/or collect in Stagio. This policy is not applicable to any
      ...
      <p>
        Stagio follows a standard procedure of using log files. These files log
      ...
      <p>
        Like any other website, Stagio uses 'cookies'. These cookies are used to
      ...
      <p>
        ...
        advertising partners of Stagio.
      </p>

      <p>
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on Stagio, which are sent directly
      ...
      <p>
        Note that Stagio has no access to or control over these cookies that are
      ...
      <p>
        Stagio's Privacy Policy does not apply to other advertisers or websites.
      ...
      <p>
        Stagio does not knowingly collect any Personal Identifiable Information
